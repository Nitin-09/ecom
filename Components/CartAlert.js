        ...
        <div id='cartAlert' className='absolute z-50 hidden'>
            <div className='bg-white p-5 fixed right-0 sm:right-2 md:right-6 lg:right-14 top-0 border-[8px] border-black border-double '>
                <div className='flex flex-col'>
                    <div className='flex justify-end'><button onClick={() => document.getElementById('cartAlert')?.classList?.add('hidden')}><i className="fa-solid fa-xmark"></i></button></div>
                    ...
                    <button className='bg-black mt-5 p-2 text-white border border-white rounded-xl font-medium'>CHECK OUT</button>
                    <button className='text-base p-4 font-semibold underline underline-offset-2'>Continue shopping</button>
