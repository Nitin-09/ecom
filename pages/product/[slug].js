...
export default function Page() {
  ...
  useEffect(() => {}, [selectedProduct, quantity]);
  ...
  return (
    <div className="text-white min-h-screen bg-black">
      <div className="bg-black pt-36 sm:pt-32 lg:pt-28 px-5 lg:px-20 flex flex-col lg:flex-row">
        <div
          id="div"
          className="basis-3/4 2xl:basis-5/6 flex lg:grid lg:grid-rows-2 gap-5 overflow-scroll lg:overflow-hidden"
        >
          <Image
            ...
            if (index > 0)
              return (
                <Image
                  ...
                  src={`https://res.cloudinary.com/${process.env.NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME}/image/upload/${item}`}
                  width={1000}
                  height={1000}
                  alt="hello"
                ></Image>
        ...
        <div className="basis-2/5 relative">
          <div className="flex flex-col lg:px-10 sticky top-0">
            <div className="flex flex-row lg:flex-col justify-between lg:justify-start items-center lg:items-start w-full">
              ...
              <span className="text-sm text-gray-200 py-5">
            ...
            <div>
                  ...
                  if (
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          seActiveSize(item);
                          document
                            .getElementById("sizeAlert")
                            ?.classList?.add("hidden"),
                            dispatch(updateQuantityInCart({ qty: 1, i: 0 }));
                        }}
                        className={`shadow-sm shadow-gray-800 ${
                          activeSize === item ? "border" : ""
                        } border-white text-xs sm:text-base text-white rounded-lg w-fit h-fit p-5`}
                      >
                        {item}
                      </button>
                    );
                    ...
                    return (
                      <button
                        ...
                        className={`shadow-sm shadow-gray-800 ${
                          activeSize === item ? "border" : ""
                        } border-white text-xs sm:text-base text-white bg-gray-900 rounded-lg w-fit h-fit p-5 cursor-not-allowed`}
                      >
                        {item}
                      </button>
                    );
              ...
              <span id="sizeAlert" className="hidden text-red-500 pt-2">
            ...
            <button
              ...
              className="bg-white mt-5 p-2 text-black rounded-xl font-medium"
            >
              ADD TO CART
            </button>
            <Link
